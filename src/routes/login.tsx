  ...
  return (
    <div className="min-h-screen grid place-items-center px-4">
      <div className="w-full max-w-md glass-strong rounded-2xl p-8 border border-primary/30">
        ...
        <p className="text-sm text-muted-foreground mt-1">Log in to your DonutVault account.</p>
        <form onSubmit={submit} className="mt-6 space-y-3">
          ...
          <div>
            ...
            <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="mt-1 w-full h-11 px-3 rounded-lg bg-input/60 border border-border focus:ring-2 focus:ring-primary/50 outline-none" />
          </div>
